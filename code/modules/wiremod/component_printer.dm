...
/obj/machinery/component_printer/Initialize(mapload)
	...
	materials = AddComponent(/datum/component/material_container, subtypesof(/datum/material), 0, MATCONTAINER_EXAMINE)
...
// /obj/machinery/component_printer/tgui_act(action, list/params)
// 	. = ..()
// 	if (.)
// 		return
...
/obj/machinery/component_printer/tgui_data(mob/user)
	var/list/data = list()
	data["materials"] = materials.tgui_data()
	return data

/obj/machinery/component_printer/tgui_static_data(mob/user)
	var/list/data = list()
...
/obj/machinery/component_printer/attackby(obj/item/O, mob/user)
